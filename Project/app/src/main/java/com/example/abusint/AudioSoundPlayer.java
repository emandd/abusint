...
public class AudioSoundPlayer {
    ...
    //SparseArray в кач-ве ключа всегда выступаютпрмитивные типы long, int  и т.д.
    ...
    private class PlayThread extends Thread {
        ...
        public void run() {
            try {
                ...
                float logVolume = (float)
                        (1 - (Math.log(MAX_VOLUME - CURRENT_VOLUME) / Math.log(MAX_VOLUME)));
